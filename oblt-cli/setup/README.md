...
| `username`      | Username to show in the deployments with oblt-cli, format: [a-z0-9_-]. Defaults to the GitHub repository name (without the owner prefix). Any characters outside [a-z0-9_-] are stripped. | `false`  | ` `                |
