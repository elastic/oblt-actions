...
#  $4 -> the BK build message. Mandatory.
#  $5 -> the Pipeline version. Mandatory.
...
PIPELINE=${2:?$MSG}
BUILD_VARS=${3:-''}
MESSAGE=${4:-"Triggered automatically with GH actions"}
PIPELINE_VERSION=${5:-"HEAD"}
PIPELINE_BRANCH=${6:-"main"}
